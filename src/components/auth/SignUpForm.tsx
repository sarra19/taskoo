...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  if (!isChecked) {
    setErrorMsg("You must accept Terms and Conditions");
    return;
  }
  ...
  try {
    ...
    if (!res.ok) {
      ...
      // ✅ Autres erreurs
      setErrorMsg(data.message || data.error || "Register failed");
      return;
    }
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center gap-3">
                ...
                {errorMsg && (
                <p className="text-sm text-center text-error-500">{errorMsg}</p>
              )}
              <button
                type="submit"
                disabled={loading}
